...
class MyPlot extends PluginBase implements Listener
{
    ...
    public function getPlotPosition(Plot $plot) {
        ...
        return new Position($x, 64, $z, $level);
    }
    ...
    public function onEnable() {
		...
		foreach(glob($this->getServer()->getDataPath() . "worlds/*") as $world) { $world = str_replace($this->getServer()->getDataPath() . "worlds/", "", $world); if($this->getServer()->isLevelLoaded($world)){
      continue; } $this->getServer()->loadLevel($world); }
