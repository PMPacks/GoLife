...
$form->addLabel("§b§lFacebook:§6 fb.com/levanlocvip123");
$form->addLabel("§c§cEmail:§6 levanloc8112@gmail.com");
$form->addLabel("§a§lSố Điện Thoại:§6 Cập Nhật....");
$form->addLabel("§a§lNếu bạn đang muốn nạp thẻ hãy\nLiên hệ một trong những cách trên");
$form->sendToPlayer($sender);
			break;
			}
		});
...
break;
   ...
   $form->setTitle("§a-+=[]» §bG§cO§2E§5-§6Co§9in§a §a«[]=+-");
...
$form->addLabel("§b§lFacebook:§6 fb.com/levanlocvip123");
$form->addLabel("§c§cEmail:§6 levanloc8112@gmail.com");
$form->addLabel("§a§lSố Điện Thoại:§6 Ếu Cho.");
...
$form->sendToPlayer($sender);
	...
	$form->setContent("§e§l•§c MY §9COIN:§a ".$this->getMoney($sender->getName()));
	$form->addButton("§l§e» §6TOP §9COIN§e «");
	$form->addButton("§l§e» §cPAY §9COIN§e «");
	$form->addButton("§l§e» §3VIEW §9COIN§e «");
	$form->addButton("§l§e» §dGIÁ §9COIN§e «");
	$form->addButton("§l§e» §2MUA §6VIP§e «");
	$form->addButton("§l§e» §1NẠP §9COIN§e «");
	$form->sendToPlayer($sender);
	break;
            case "coin":
                $subCommand = strtolower(array_shift($args));
   ...
   $form->sendToPlayer($sender);*/
	...
	$form->setTitle("§0§l-+=[§4||§0]§2G§cO§9E§a-§6CO§2IN§0 [§4||§0]=+-");
