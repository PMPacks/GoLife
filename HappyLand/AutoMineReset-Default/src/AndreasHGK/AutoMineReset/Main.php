...
class Main extends PluginBase{
	...
	public function resetAll(){
		...
		Server::getInstance()->broadcastMessage(C::BOLD.C::AQUA."»".C::RESET.C::DARK_AQUA." Đang Làm Đầy Tất Cả Khu Mine!");
		Server::getInstance()->broadcastMessage(C::BOLD.C::AQUA."»".C::RESET.C::DARK_AQUA." Tất Cả Khu Mine Đã Được Làm Đầy!");
		}
