...
class TradeUI extends PluginBase{
	...
	public function onEnable(){
	        $this->BUY_OR_SELL_UI_ID = mt_rand(100, 10000);
	...
	public function setEconomyProvider(EconomyProvider $provider){
        ...
        public function getBuyOrSellForm(Player $player) {
                ...
                $form->setTitle(RandomUtils::colorMessage("&e&k|&r&5&lBlackShop&r&k&e|"));
                $content = "";
        ...
        public function getShopForm(Player $player, string $from = null) {
                ...
                if($from !== null){
                        ...
                        if(count($s) != 0){
                                ...
                                $form->setTitle(RandomUtils::colorMessage("&e&k|&r&5&l{$from}'s BlackShop&r&k&e|"));
                                foreach($s as $r) {
                        ...
                        if($s !== null){
                                if(count($s) != 0){
                                        ...
                                        $page = $pg[1];
                                        $max = $pg[2];
                                        $form->setTitle(RandomUtils::colorMessage("&e&k|&r§d&lBlackShop&r&k&e|&r"));
                                        $form->setButton(RandomUtils::colorMessage("&l&k&e|&r&l&d← Back&e&k|"));
