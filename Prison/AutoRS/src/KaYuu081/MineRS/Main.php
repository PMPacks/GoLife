...
class Main extends PluginBase{
	...
	public function onCommand(CommandSender $sender, Command $cmd, string $label, array $args) : bool{
		...
		case "autoreset":
			if($sender->hasPermission("amr.autoreset")){
				...
				$this->paused = true;
				$sender->sendMessage(C::BOLD.C::AQUA."»".C::RESET.C::DARK_AQUA."Đã được tự động ".C::RED."Bật".C::DARK_AQUA."!");
				$this->getLogger()->notice(C::GREEN."Thời gian reset tạm hoãn vì không có người chơi".$sender->getName()."!");
	...
	public function resetAll(){
		...
		Server::getInstance()->broadcastMessage(C::BOLD.C::RED."»".C::RESET.C::YELLOW." Đang Làm Đầy Tất Cả Khu Mine!");
		Server::getInstance()->broadcastMessage(C::BOLD.C::RED."»".C::RESET.C::YELLOW." Đã làm đầy!");
