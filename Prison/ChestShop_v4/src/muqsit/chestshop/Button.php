...
class Button{
	...
	private static $options = [
		"turn_left" => [
			...
			"damage" => 0,
			"count" => 1,
			"name" => TF::RESET.TF::GOLD.TF::BOLD."§d<-§c Quay lại",
			"lore" => [
				TF::RESET.TF::GRAY."Quay lại trang đầu"
			]
		],
		"turn_right" => [
			"id" => Item::PAPER,
			"damage" => 0,
			"count" => 1,
			"name" => TF::RESET.TF::GOLD.TF::BOLD."• Trang tiếp theo§d ->",
			"lore" => [
				TF::RESET.TF::GRAY."Trang tiếp theo."
			]
		],
		"categories" => [
			"id" => Item::CHEST,
