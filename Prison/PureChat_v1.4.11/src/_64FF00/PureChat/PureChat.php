...
class PureChat extends PluginBase
{
    ...
    */
    ...
    public function onCommand(CommandSender $sender, Command $cmd, string $label, array $args) : bool{
        switch(strtolower($cmd->getName()))
        {
            case "setformat":
                ...
                $this->setOriginalChatFormat($group, $group2, $chatFormat, $levelName);
            ...
            case "setnametag":
                ...
                $this->setOriginalNametag($group, $group2, $nameTag, $levelName);
    ...
    private function fixOldData($string)
    {
		...
		$string = str_replace("{rank2}", "{rank}", $string);
